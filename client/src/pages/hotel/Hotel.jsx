...
const Hotel = () => {
  ...
  const { data, loading, reFetch } = useFetch(`${PROXY}/hotels/find/${id}`);
            ...
            <div className="hotelWrapper">
              ...
              <div className="hotelImages">
                {data.photos.length > 0 ? (
                  ...
                  <div className="defaultHotelImgWrapper">
                    <img
                      src="http://wtlrealty.my/admin/property/default.jpg"
                      alt=""
                      className="defaultHotelImg"
                    />
                  </div>
                )}
              </div>
